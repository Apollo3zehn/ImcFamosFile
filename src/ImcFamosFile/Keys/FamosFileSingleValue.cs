...
public class FamosFileSingleValue<T> : FamosFileSingleValue where T : unmanaged
{
    ...
    public unsafe FamosFileSingleValue(string name, T value) : base(name, (byte*)(&value), Marshal.SizeOf<T>())
    {
        ...
        {
            byte _ => FamosFileDataType.UInt8,
            sbyte _ => FamosFileDataType.Int8,
            ushort _ => FamosFileDataType.UInt16,
            short _ => FamosFileDataType.Int16,
            uint _ => FamosFileDataType.UInt32,
            int _ => FamosFileDataType.Int32,
            float _ => FamosFileDataType.Float32,
